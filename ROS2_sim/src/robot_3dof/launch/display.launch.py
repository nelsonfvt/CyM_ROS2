...
def generate_launch_description():
    pkg_share = Path(FindPackageShare(package='robot_3dof').find('robot_3dof'))
    ...
    robot_control = launch_ros.actions.Node(
        package='robot_3dof',
        executable='robot_3dof',
        name='robot_3dof',
    )
